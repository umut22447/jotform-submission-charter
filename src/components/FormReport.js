            ...
            <div className='d-flex flex-wrap mw-1000'>
                ...
                <div className='new-chart-add-root-div noexport'>
                    <div className='d-flex flex-column w-100'>
                        ...
                        <button onClick={handleAddClick} className="btn btn-outline-success h-100"><svg width="4em" height="4em" viewBox="0 0 16 16" className="bi bi-plus-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
